...
Porto inherits concepts from the DDD (Domain Driven Design), MVC (Model View Controller) and Micro-Services architectural patterns. And it adapts to techniques from the Layered, Hexagonal and Modular software architectures.
As well as, it adheres to a list of convenient design principles such as SOLID, OOP, LIFT, DRY, CoC, GRASP, Generalization, High Cohesion and Low Coupling.
...
- Avoid bloated Classes and unmaintainable code (Single Responsibility Principle).
...
Separation of concerns, is another important principle, Porto tries to follow.
